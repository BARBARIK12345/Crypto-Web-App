        ...
        <>
          ...
          {response.map((exchng , indx)=>(
            ...
            >
              ...
              <Center><Image h={'8rem'} w={'8rem'} src={exchng.image}m={'0.3rem'}/></Center>
              <Text textAlign={'center'} fontSize={'x-large'} m={'0.3rem'} fontWeight={'bold'}>{exchng.trust_score_rank}</Text>
              <Text textAlign={'center'} fontSize={'x-large'}m={'0.3rem'} fontWeight={'bold'}>{exchng.name}</Text>
